    ...
    publications {
        main {
            pom {
                ...
                url.set("https://github.com/ideal-state/sugar-next-jedis-mybatis-cache-boot")
                licenses {
                    license {
                ...
                scm {
                    url.set("https://github.com/ideal-state/sugar-next-jedis-mybatis-cache-boot")
                    connection.set("scm:git:https://github.com/ideal-state/sugar-next-jedis-mybatis-cache-boot.git")
                    developerConnection.set("scm:git:https://github.com/ideal-state/sugar-next-jedis-mybatis-cache-boot.git")
                }
                developers {
                    developer {
                        id.set("ideal-state")
